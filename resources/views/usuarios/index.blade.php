    ...
    <div class="display">
        ...
        <div class="tableContainer">
            <table class="tableView" id="tableTrucks">
                <thead>
                    <tr>
                        <th style="width: 15%;" onclick="sortTable(0);arrowsTable(0);" id="0">
                            {{ __('Usuario') }}</th>
                        <th style="width: 15%;" onclick="sortTable(0);arrowsTable(0);" id="0">
                            {{ __('Rol') }}</th>
                        <th style="width: 25%;" onclick="sortTable(0);arrowsTable(0);" id="0">
                            {{ __('Email') }}</th>
                        <th style="width: 20%;" onclick="sortTable(0);arrowsTable(0);" id="0">
                            {{ __('Verificacion email') }}</th>
            ...
            <form action="{{ route('usuarios.store') }}" method="POST">
                ...
                <div style="margin-top: 1vh; display: flex; justify-content: space-between">
                    ...
                    <select name="tipo" id="tipo">
                        ...
                        <option value="2" {{ old('tipo') == '2' ? 'selected' : '' }}>{{ __('Camionero') }}
                        </option>
                ...
                <div id="almacenClienteInput" style="margin-top: 1vh; display: none; justify-content: space-between">
