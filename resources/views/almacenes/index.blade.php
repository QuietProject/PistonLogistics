    ...
    <div class="display">
        ...
        <div class="tableContainer">
            <table class="tableView" id="tablePropios">
                <thead>
                    <tr>
                        <th style="width: 10%;" onclick="sortTable(0);arrowsTable(0);" id="0">{{ __("ID") }}</th>
                        <th style="width: 30%;" onclick="sortTable(1);arrowsTable(1);" id="1">{{ __("Nombre") }}</th>
                        <th style="width: 30%;" onclick="sortTable(2);arrowsTable(2);" id="2">{{ __("Direccion") }}</th>
                        <th style="width: 30%;" onclick="sortTable(3);arrowsTable(3);" id="3">{{ __("Estado") }}</th>
                    </tr>
                </thead>
                <tbody>
        ...
        <div class="tableContainer" style="left: 50vw;">
            <table class="tableView" id="tableClientes">
                <thead>
                    <tr>
                        <th style="width: 10%;" onclick="sortTableAlternate(0);arrowsTable(4);"" id="4">{{ __("ID") }}</th>
                        <th style="width: 25%;" onclick="sortTableAlternate(1);arrowsTable(5);"" id="5">{{ __("Nombre") }}</th>
                        <th style="width: 25%;" onclick="sortTableAlternate(2);arrowsTable(6);"" id="6">{{ __("Direccion") }}</th>
                        <th style="width: 20%;" onclick="sortTableAlternate(3);arrowsTable(7);"" id="7">{{ __("Cliente") }}</th>
                        <th style="width: 20%;" onclick="sortTableAlternate(4);arrowsTable(8);"" id="7">{{ __("Estado") }}</th>
                    </tr>
                </thead>
                <tbody>
                ...
                <form action="{{ route('almacenes.store') }}" method="POST">
                    ...
                    <div class="inputBox" style="display: flex; justify-content: space-between">
                        ...
                        <select name="tipo" id="tipo2">
                            ...
                            <option value="cliente" {{ old('tipo') == 'cliente' ? 'selected' : '' }}>{{ __("Cliente") }}</option>
                        </select>
                    </div>
                    <div class="inputBox" style="display: flex; justify-content: space-between">
